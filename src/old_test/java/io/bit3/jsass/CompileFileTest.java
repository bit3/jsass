...
public class CompileFileTest extends AbstractCompileTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][]{
            {"scss", StringOptions.OutputStyle.COMPRESSED},
            {"scss", StringOptions.OutputStyle.NESTED},
            {"sass", StringOptions.OutputStyle.COMPRESSED},
            {"sass", StringOptions.OutputStyle.NESTED},
        }
    );
  }
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithoutMap(String syntax, StringOptions.OutputStyle outputStyle) throws Exception {
    this.syntax = syntax;
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithMap(String syntax, StringOptions.OutputStyle outputStyle) throws Exception {
    this.syntax = syntax;
    this.outputStyle = outputStyle;
    this.setUp();
