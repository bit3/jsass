...
public class CompileStringTest extends AbstractCompileTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][]{
            {"scss", StringOptions.OutputStyle.COMPRESSED, false},
            {"scss", StringOptions.OutputStyle.NESTED, false},
            {"sass", StringOptions.OutputStyle.COMPRESSED, true},
            {"sass", StringOptions.OutputStyle.NESTED, true},
        }
    );
  }
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithoutMap(String syntax, StringOptions.OutputStyle outputStyle, boolean isIndentedStyle) throws Exception {
    this.syntax = syntax;
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithMap(String syntax, StringOptions.OutputStyle outputStyle, boolean isIndentedStyle) throws Exception {
    this.syntax = syntax;
    this.outputStyle = outputStyle;
    this.isIndentedStyle = isIndentedStyle;
    this.setUp();
