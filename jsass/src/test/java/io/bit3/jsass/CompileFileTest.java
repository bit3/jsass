...
public class CompileFileTest extends AbstractCompileTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][]{
            {"scss", Options.OutputStyle.COMPRESSED},
            {"scss", Options.OutputStyle.NESTED},
            {"sass", Options.OutputStyle.COMPRESSED},
            {"sass", Options.OutputStyle.NESTED},
        }
    );
  }
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithoutMap(String syntax, Options.OutputStyle outputStyle) throws Exception {
    this.syntax = syntax;
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithMap(String syntax, Options.OutputStyle outputStyle) throws Exception {
    this.syntax = syntax;
    this.outputStyle = outputStyle;
    this.setUp();
