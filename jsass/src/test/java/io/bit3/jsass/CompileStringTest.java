...
public class CompileStringTest extends AbstractCompileTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][]{
            {"scss", Options.OutputStyle.COMPRESSED, false},
            {"scss", Options.OutputStyle.NESTED, false},
            {"sass", Options.OutputStyle.COMPRESSED, true},
            {"sass", Options.OutputStyle.NESTED, true},
        }
    );
  }
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithoutMap(String syntax, Options.OutputStyle outputStyle, boolean isIndentedStyle) throws Exception {
    this.syntax = syntax;
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testWithMap(String syntax, Options.OutputStyle outputStyle, boolean isIndentedStyle) throws Exception {
    this.syntax = syntax;
    this.outputStyle = outputStyle;
    this.isIndentedStyle = isIndentedStyle;
    this.setUp();
